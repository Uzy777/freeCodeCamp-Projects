...
*Q2) Which of the following is the correct way to call (or invoke) the sum function?*
...
*Q3) What is the default return value of a function if no return statement is specified?*
