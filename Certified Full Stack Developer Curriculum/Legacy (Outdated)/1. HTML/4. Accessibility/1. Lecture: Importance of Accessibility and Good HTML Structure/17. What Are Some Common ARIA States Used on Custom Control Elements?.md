...
---
## Question
*Q) What ARIA state would you use to indicate that a tab is currently selected?*
...
*Q) In the context of custom controls, which ARIA state is used to indicate that an element is currently disabled?*
...
*Q) When you want to indicate that a menu item has a submenu, which ARIA state should be used?*
