...
<table><tbody><tr><td></td><th scope="col">Name</th><th scope="col">Age</th></tr><tr><th rowspan="2" scope="row">Dogs</th><th scope="row">Nora</th><td>5</td></tr><tr><th scope="row">Gino</th><td>2</td></tr><tr><th rowspan="2" scope="row">Cats</th><th scope="row">Lulu</th><td>10</td></tr><tr><th scope="row">Elizabeth</th><td>6</td></tr></tbody></table>
...
---
## Questions
*Q) Which HTML element is used to specify the title of a table?*
...
*Q) What is the purpose of the scope attribute in a table header cell (th)?*

A) To specify the colspan and rowspan of the cell.  
B) To indicate whether the header applies to a row or a column.  
C) To define the style of the header cell.  
D) To add a tooltip to the header cell.  
...
*Q) Which of the following is a best practice for creating accessible tables?*

A) Using complex and long table headers.  
B) Not providing alternative text for images within table cells.  
C) Using simple table structures with row and column headers.  
D) Nesting tables within tables.  
