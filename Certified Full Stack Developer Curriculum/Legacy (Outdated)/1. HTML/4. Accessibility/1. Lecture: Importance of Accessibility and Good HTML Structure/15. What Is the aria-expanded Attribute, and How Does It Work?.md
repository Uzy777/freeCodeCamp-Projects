...
---
## Questions
*Q) What is the primary purpose of the aria-expanded attribute?*

A) To define the visual appearance of an element.  
B) To improve website performance.  
C) To indicate whether an element is expanded or collapsed.  
...
*Q) When should the aria-expanded attribute be used?*

A) For all elements on a web page.  
B) For elements that are visually hidden.  
C) For collapsible elements like menus and accordions.  
D) For elements with dynamic content.  
...
*Q) What are the possible values for the aria-expanded attribute?*
