...
---
## Questions
*Q1) What is the primary purpose of the text-shadow CSS property?*

A) To adjust the font size of text.  
B) To change the color of text.  
C) To create a shadow effect for text.  
...
*Q2) How can you create a black text shadow with a horizontal offset to the right and a blur radius of 5 pixels?*

A) text-shadow: 5px 0px 0px black;  
B) text-shadow: 5px 0px 5px black;  
...
*Q3) How can you create a multiple-layered text shadow effect?*

A) By defining multiple shadows in the text-shadow property.  
B) By nesting elements within each other.  
C) By using the filter property.  
D) By applying a background image.  
