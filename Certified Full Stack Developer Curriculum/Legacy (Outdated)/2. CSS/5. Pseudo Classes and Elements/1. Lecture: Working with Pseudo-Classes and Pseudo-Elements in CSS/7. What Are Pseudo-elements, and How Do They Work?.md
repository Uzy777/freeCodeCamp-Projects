...
---
## Questions
*Q1) Which of these best describes the relationship between pseudo-elements and their originator element?*

A) Pseudo-elements can exist independently of the originator element.  
B) Pseudo-elements must always be declared before the originator element.  
C) Pseudo-elements depend on the originator element and cannot exist independently.  
D) Pseudo-elements are used to create new HTML elements.  
...
*Q2) Which of these correctly distinguishes pseudo-elements from pseudo-classes?*

A) Pseudo-elements use a single colon, while pseudo-classes use a double colon.  
B) Pseudo-elements use a double colon, while pseudo-classes use a single colon.  
C) Both pseudo-elements and pseudo-classes use the same colon notation.  
D) Pseudo-classes require a double colon, while pseudo-elements do not.  
...
*Q3) Which of these best describes the function of pseudo-elements in CSS?*

A) They add new HTML elements to the document.  
B) They style specific parts of an element's content without adding extra HTML tags.  
C) They replace the entire content of an element with new content.  
D) They modify the structure of the HTML document.  
