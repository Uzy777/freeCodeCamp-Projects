...
---
## Questions
*Q1) What is contrast in the context of web design?*

A) The brightness of colors on a webpage.  
B) The difference between two colors and how easily they can be distinguished.  
C) The number of colors used on a webpage.  
D) The sharpness of images on a webpage.  
...
*Q2) According to the Web Content Accessibility Guidelines (WCAG), what is the minimum contrast ratio for text to meet the AA standard?*
...
*Q3) Which of the following is NOT mentioned as an aspect that impacts the contrast ratio?*
