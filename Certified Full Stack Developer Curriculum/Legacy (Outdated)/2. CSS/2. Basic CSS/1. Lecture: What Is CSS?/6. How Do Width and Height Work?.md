...
---
## Questions
*Q) What will happen if you set width: 600px; and max-width: 500px; on a div element?*

A) The element will be 600px wide.  
B) The element will be 500px wide.  
C) The element will be 550px wide.  
D) The element will be 100px wide.  
...
*Q) If you set min-height: 200px and height: 150px on an element, what will be the height of the element?*
...
*Q) Which of the following units can be used to set the width or height of an element?*

A) px, %, and em.  
B) pxx, depth, and radius.  
C) %% , mb, and vel.  
D) All of the above.  
