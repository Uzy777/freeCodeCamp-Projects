...
---
## Questions
*Q1) Which of the following is the default value for the box-sizing property in most browsers?*
...
*Q2) What is the primary advantage of using border-box for creating responsive layouts?*

A) It makes the calculations more complicated.  
B) It allows for more precise control over element dimensions.  
C) It ensures that elements maintain their specified dimensions regardless of changes in padding or border.  
...
*Q3) In the content-box model, what does the specified width of an element represent?*

A) The total width of the element, including padding, border, and margin.  
B) The width of the content area only.  
C) The width of the border.  
D) The width of the padding.  
