...
---
## Questions
*Q1) Which CSS property is used to align child elements horizontally (by default) within a flex container?*
...
*Q2) Which CSS property is used to align child elements vertically (by default) within a flex container?*
...
*Q3) Which of the following properties can be combined into the flex-flow property?*

A) flex-direction and justify-content.  
B) flex-direction and align-items.  
C) flex-direction and align-content.  
