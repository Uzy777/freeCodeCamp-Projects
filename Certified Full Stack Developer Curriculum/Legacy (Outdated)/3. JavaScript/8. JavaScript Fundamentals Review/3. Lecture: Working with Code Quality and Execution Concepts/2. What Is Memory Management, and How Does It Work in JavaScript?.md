...
*Q1) In JavaScript, who is primarily responsible for managing memory?*
...
*Q2) What is the process called when JavaScript automatically frees up memory that's no longer needed?*
...
*Q3) Which of the following is a potential downside of JavaScript's automatic memory management?*

A) It requires more code to be written.  
B) It can sometimes keep memory allocated that's no longer needed.  
C) It makes the program run slower.  
D) It requires manual memory deallocation.  
