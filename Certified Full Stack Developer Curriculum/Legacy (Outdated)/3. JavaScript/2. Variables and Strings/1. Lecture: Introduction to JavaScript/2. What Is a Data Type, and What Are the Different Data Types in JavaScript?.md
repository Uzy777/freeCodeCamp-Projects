...
*Q1) Which of the following is a string data type?*
...
*Q2) What data type represents a value that is either true or false?*
...
*Q3) If a variable has been declared but not assigned a value, what is its data type?*
