...
## Questions
*Q) Which HTML element is used for displaying extended quotations from other sources?*
...
*Q) What is the purpose of the cite element in HTML?*

A) To display inline quotations.  
B) To specify the source URL of a quotation.  
C) To mark up the title of a referenced creative work.  
D) To display extended quotations.  
...
*Q) Which HTML attribute is used to specify the source of a quotation in a block or inline quotation element?*
