...
---
## Questions
*Q1) What is the purpose of the @keyframes rule in CSS animations?*

A) To specify the duration of the animation.  
B) To define the stages and styles of the animation.  
C) To set the timing function of the animation.  
D) To determine how many times the animation repeats.  
...
*Q2) In the following CSS code, what does 2s represent?*
```css
.element {
...
A) The delay before the animation starts. 
B) The number of times the animation repeats. 
C) The duration of the animation.  
D) The percentage of the animation's progress.
...
*Q3) Which CSS property would you use to make an animation repeat indefinitely?*
