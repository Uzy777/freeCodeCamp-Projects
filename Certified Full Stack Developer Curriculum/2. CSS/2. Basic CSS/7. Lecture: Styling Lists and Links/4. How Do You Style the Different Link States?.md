...
---
## Questions
*Q1) Which CSS pseudo-class is used to style links that have not been visited?*
...
*Q2) What visual change does the hover state typically involve in CSS?*

A) The link becomes larger.  
B) The link text color changes.  
C) The link text becomes bold.  
D) The link text is underlined.  
...
*Q3) Which CSS pseudo-class would you use to add a visible outline around a link when it is navigated to using the keyboard?*
