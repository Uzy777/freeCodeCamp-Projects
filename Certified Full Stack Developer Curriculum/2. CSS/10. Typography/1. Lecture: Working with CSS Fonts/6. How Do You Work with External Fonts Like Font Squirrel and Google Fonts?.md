...
---
## Questions
*Q1) What is the primary advantage of using external fonts from services like Font Squirrel or Google Fonts?*

A) Reduced font file size.  
B) Increased font rendering speed.  
C) Expanded font selection and variety.  
...
*Q2) What is a potential drawback of using multiple external fonts?*

A) Increased website load time.  
B) Increased likelihood of bugs.  
C) Limited customization options.  
D) Increased browser compatibility.  
...
*Q3) What is the importance of providing fallback fonts when using external fonts?*

A) To create a more visually appealing design.  
B) To improve font rendering performance.  
C) To display the text correctly, even if the external font is not loaded properly.  
