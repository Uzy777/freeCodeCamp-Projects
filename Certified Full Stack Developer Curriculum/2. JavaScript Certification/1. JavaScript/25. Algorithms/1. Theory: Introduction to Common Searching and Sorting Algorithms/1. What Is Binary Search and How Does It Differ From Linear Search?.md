...
Q) What is the main difference between linear search and binary search?
...
**Answer: Binary search requires a sorted list, while linear search does not.**
...
Q) In binary search, what happens if the target value is not found in the list?
