...
Q) What do both setTimeout() and setInterval() methods take as parameters?
...
**Answer: A function and a delay.**

---

Q) What does the setInterval() method do in JavaScript?
...
**Answer: It repeatedly runs a function at a set interval, like an alarm going off every few seconds.**

---

Q) What does the setTimeout() method do in JavaScript?
...
**Answer: It delays an action for a specified time and then runs a function.**
