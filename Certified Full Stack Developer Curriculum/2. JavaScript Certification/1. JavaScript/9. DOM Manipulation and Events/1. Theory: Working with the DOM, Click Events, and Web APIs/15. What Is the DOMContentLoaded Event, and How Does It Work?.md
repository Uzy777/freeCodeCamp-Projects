...
Q) What does the DOMContentLoaded event signify?
...
**Answer: The HTML document has been fully loaded and parsed.**

---

Q) How does the DOMContentLoaded event differ from the load event?
...
**Answer: DOMContentLoaded fires before all resources are loaded, while load waits for everything.**

---

Q) In the provided example, what happens if the DOMContentLoaded event has already fired when the script runs?
...
**Answer: The changeImg function will be called directly.**
