...
Q) What is the purpose of the Event object in JavaScript?
...
**Answer: To provide information about user interactions with a web page**

---

Q) Which of the following properties is always available on all Event objects?
...
Q) What does the preventDefault() method do when called on an Event object?
...
**Answer: It prevents the default behavior of the event.**
