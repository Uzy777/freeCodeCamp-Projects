...
Q) What is the primary method in the Web Animations API (WAAPI) for creating animations?
...
Q) Which of these is not an instance method of the Animation constructor in the Web Animations API (WAAPI)?
...
Q) When should you use WAAPI over CSS animations?
...
**Answer: When you need animations to respond to user interactions like clicks, scrolls, or allow dynamic control such as pausing or reversing.**
