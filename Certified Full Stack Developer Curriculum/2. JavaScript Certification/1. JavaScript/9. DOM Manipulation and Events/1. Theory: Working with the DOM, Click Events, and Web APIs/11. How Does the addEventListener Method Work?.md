...
Q) What is the purpose of the addEventListener() method?
...
**Answer: To listen for events on an HTML element.**

---

Q) What does the EventListener interface define?
...
**Answer: The structure for event handling.**

---

Q) What type of event would you use addEventListener() with to capture user input in a text field?
