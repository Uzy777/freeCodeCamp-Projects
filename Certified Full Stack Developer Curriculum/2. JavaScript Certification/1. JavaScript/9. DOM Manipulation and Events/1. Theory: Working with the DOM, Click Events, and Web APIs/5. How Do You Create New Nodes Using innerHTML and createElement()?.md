...
Q) What is the primary purpose of the innerHTML property?
...
**Answer: To dynamically inject HTML content into an element.**

---

Q) Which of the following methods is used to create a new HTML element in JavaScript?
...
Q) What is the main risk of using innerHTML when you do not have control over the string?
...
**Answer: Insertion of malicious content.**
