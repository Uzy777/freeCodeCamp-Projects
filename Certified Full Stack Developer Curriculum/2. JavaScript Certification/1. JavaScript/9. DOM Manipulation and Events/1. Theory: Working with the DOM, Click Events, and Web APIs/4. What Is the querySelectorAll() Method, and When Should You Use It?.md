...
Q) What is the primary purpose of the querySelectorAll() method in JavaScript?
...
**Answer: To select multiple elements based on a CSS selector.**

---

Q) What type of object does the querySelectorAll() method return?
...
Q) When using querySelectorAll() with a string selector, what happens if the selector doesn't match any elements?
...
**Answer: An empty NodeList is returned.**
