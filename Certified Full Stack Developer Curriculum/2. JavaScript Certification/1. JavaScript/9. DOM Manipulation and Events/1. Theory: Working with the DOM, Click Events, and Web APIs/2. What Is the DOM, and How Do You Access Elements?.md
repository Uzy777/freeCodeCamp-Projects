...
**Answer: A tree-structured representation of an HTML document.**

---

Q) Which of the following methods can be used to access an element by its id in JavaScript?
...
Q) What is the primary purpose of the querySelector() method?
...
**Answer: To select an element based on a CSS selector.**
