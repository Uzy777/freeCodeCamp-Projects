...
Q) Which property would you use to directly change the color of an element's text using JavaScript?
...
Q) How would you add multiple classes to an element using the Element.classList property?
...
**Answer: classList.add("class1", "class2", "class3")**

---

Q) What will happen if you click the button in the provided example multiple times?
...
**Answer: The menu will toggle between visible and hidden each time the button is clicked.**
