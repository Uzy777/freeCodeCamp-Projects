...
Q) What does the navigator.userAgent property return?
...
**Answer: A string identifying the browser and operating system.**

---

Q) Which property of the Window interface provides information about the current URL?
...
Q) How can you access the Document interface properties without explicitly using the window object?
