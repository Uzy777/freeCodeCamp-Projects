...
Q) What does the appendChild() method do?
...
Q) How would you add text content to a newly created list item element?
...
**Answer: Set the textContent property of the new node to the desired string.**

---

Q) How can you remove the last paragraph element from a section using JavaScript?
...
**Answer: Use removeChild() on the section element with the reference to the last paragraph element.**
