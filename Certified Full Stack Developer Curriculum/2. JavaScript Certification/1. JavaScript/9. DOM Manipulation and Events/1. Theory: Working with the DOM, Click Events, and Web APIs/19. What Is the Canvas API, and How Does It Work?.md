...
Q) Which method and property let you draw and fill rectangles or squares in the Canvas API?
...
**Answer: fillRect() and fillStyle.**

---

Q) Which of these is not a property or method of the CanvasRenderingContext2D interface in the Canvas API?
...
Q) How do you draw text on a canvas using the fillText() method in JavaScript?
...
**Answer: Pass the text, followed by the values for the x and y axis.**
