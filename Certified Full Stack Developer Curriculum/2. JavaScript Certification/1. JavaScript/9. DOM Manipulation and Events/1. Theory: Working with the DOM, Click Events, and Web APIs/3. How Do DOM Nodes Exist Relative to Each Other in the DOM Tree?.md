...
Q) Which of the following is the parent node of the body element?
...
Q) Three li elements within the same ul element are considered:
...
**Answer: Sibling nodes.**

---

Q) A p element contained directly within a div is a:
