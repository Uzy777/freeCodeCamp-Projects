...
Q) What is the difference between a modal dialog and a non-modal dialog?
...
**Answer: A modal dialog disables interaction with the rest of the page, while a non-modal dialog allows it.**

---

Q) Which methods are used to open a modal in JavaScript?
...
**Answer: showModal() and show().**

---

Q) How do you execute the show(), close(), and showModal() methods to open and close a modal?
...
**Answer: By adding a click event listener to a button and using the appropriate method.**
