...
**Answer: The way an event travels from child elements to parent elements.**

---

Q) What is the purpose of the stopPropagation() method?
...
**Answer: To stop an event from bubbling up to parent elements.**
...
**Answer: It reduces the number of event listeners needed for multiple elements.**
