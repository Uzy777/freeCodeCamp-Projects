...
1) What method would you use to format a date in the ISO 8601 format?
...
2) Which method formats the date based on the user's locale?
...
3) What optional parameters can you provide to the toLocaleDateString() method?
