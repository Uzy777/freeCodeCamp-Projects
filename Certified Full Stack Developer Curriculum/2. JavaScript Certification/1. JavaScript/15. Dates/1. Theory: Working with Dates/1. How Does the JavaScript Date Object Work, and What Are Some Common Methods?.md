...
1) What does the Date.now() method return?
...
**Answer: The number of milliseconds since January 1, 1970, 00:00:00 UTC.**

---

2) If you use the getMonth method and it returns 4, which month is being represented?
...
3) How would you create a Date object for July 4, 1776, at 12:00:00 PM?
...
**Answer: const specificDate = new Date("July 4, 1776 12:00:00");**
