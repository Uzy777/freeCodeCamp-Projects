...
1) What is the main purpose of the Cache API in web applications?
...
**Answer: To store and manage network requests and responses for offline access.**

---

2) Which of the following best describes the role of a service worker in a web application?
...
**Answer: A special JavaScript file that runs in the background, managing network requests and caching resources.**

---

3) What is a network request in the context of a web application?
...
**Answer: A request made by a web browser or application to a server to retrieve data or resources over the internet.**
