...
1) What is a key characteristic of IndexedDB operations?
...
**Answer: They are always asynchronous.**

---

2) What is the primary advantage of using IndexedDB over localStorage?
...
**Answer: IndexedDB supports storing complex JavaScript objects directly.**

---

3) In IndexedDB, what is an object store most similar to in traditional relational databases?
