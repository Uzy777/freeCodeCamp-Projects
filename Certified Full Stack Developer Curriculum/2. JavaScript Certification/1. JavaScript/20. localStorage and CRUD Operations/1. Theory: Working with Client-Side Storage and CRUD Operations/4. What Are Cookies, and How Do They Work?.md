...
1) What is the primary purpose of cookies in web applications?
...
**Answer: To store data that helps maintain state and remembers user information across requests.**

---

2) Which of the following attributes ensures that a cookie is only sent over HTTPS?
...
3) How can you delete a cookie using JavaScript?
...
**Answer: By setting its expiration date to a past date.**
