...
1) What is a potential negative use of cookies in web development?
...
**Answer: Tracking user behavior across multiple websites.**
...
**Answer: A way to identify users based on browser and system characteristics.**

---

3) Why is storing sensitive information like passwords in localStorage a security risk?
...
**Answer: Data in localStorage is not encrypted.**
