...
1) What is the purpose of the Web Storage API?
...
**Answer: To store key-value pairs in the browser.**

---

2) Which method is used to save data in local storage?
...
3) How does localStorage differ from sessionStorage?
...
**Answer: localStorage persists across browser sessions, while sessionStorage is cleared when the browser or tab is closed.**
