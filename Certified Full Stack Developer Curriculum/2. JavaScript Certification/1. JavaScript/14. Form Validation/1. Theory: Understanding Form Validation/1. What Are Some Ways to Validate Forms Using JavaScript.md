...
1) Which method of the Constraint Validation API is used to check if an input element meets all its validation constraints?
...
2) What is the purpose of the setCustomValidity() method in form validation?
...
**Answer: To display a custom error message for invalid inputs.**

---

3) Which property of the validity object becomes true when a required input field is left empty?
