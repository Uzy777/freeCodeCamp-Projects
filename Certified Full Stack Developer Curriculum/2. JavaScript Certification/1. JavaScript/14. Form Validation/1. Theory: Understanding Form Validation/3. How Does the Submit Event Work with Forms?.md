...
1) Which of the following is NOT a way to submit an HTML form?
...
**Answer: Double-clicking anywhere within the form.**

---

2) What happens when a form's action attribute is not set?
...
**Answer: The form data is sent to the current page's URL.**

---

3) Which enctype value should be used when a form includes file uploads?
