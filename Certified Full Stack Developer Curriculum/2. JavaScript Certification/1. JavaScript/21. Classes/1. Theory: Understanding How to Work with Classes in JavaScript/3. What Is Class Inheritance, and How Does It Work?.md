...
**Answer: To reuse code and create hierarchical relationships between classes.**

---

2) What is the keyword used to inherit from a parent class in JavaScript?
...
**Answer: A child class is a specialized version of a parent class.**
