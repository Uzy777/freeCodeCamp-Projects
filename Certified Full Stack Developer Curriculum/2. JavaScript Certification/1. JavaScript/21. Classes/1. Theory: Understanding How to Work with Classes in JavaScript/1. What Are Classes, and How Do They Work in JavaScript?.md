...
1) What is the primary purpose of a constructor in a JavaScript class?
...
**Answer: To initialize the properties of an object when it is created.**

---

2) What is the correct way to create an instance of a JavaScript class?
...
**Answer: Using the new keyword followed by the class name and arguments.**

---

3) What is the difference between a class and an object in JavaScript?
...
**Answer: A class is a blueprint for an object, while an object is a specific instance of that class.**
