...
1) What is the primary purpose of a static method in a JavaScript class?
...
**Answer: To define methods that can be accessed without creating an instance of the class.**

---

2) What is the main difference between a static method and an instance method in JavaScript?
...
**Answer: Static methods are associated with the class itself, while instance methods are associated with specific instances of the class.**

---

3) How can you access a static property of a class in JavaScript?
...
**Answer: By directly using the class name and the property name.**
