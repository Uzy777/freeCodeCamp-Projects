...
![Image 1: The same binary tree example highlighting that it's a binary tree, with each node having at most two children.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-trees-and-tries-and-how-do-they-work-1.png)
...
![Image 2: The same binary tree example highlighting that it's a binary tree, with each node having at most two children.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-trees-and-tries-and-how-do-they-work-1.png)
...
![Image 3: A diagram highlighting a subtree within the main tree, showing nodes C, D, and E forming their own tree structure.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-trees-and-tries-and-how-do-they-work-3.png)
...
![Image 4: A trie data structure showing the words 'top', 'tea', and 'ten'. The root node branches to 't', which then branches to 'o' (leading to 'top') and 'e' (leading to 'tea' and 'ten'). End-of-word nodes are marked with red borders.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-trees-and-tries-and-how-do-they-work-4.png)
...
Q) Which of the following statements about a Binary Search Tree (BST) is always true?
...
**Answer: All values in the left subtree of a node are less than the node's value.**

---

Q) For which of the following tasks is a trie, or prefix tree most effective?
...
Q) What is the fundamental difference between a general tree and a Binary Tree?
...
**Answer: A Binary Tree restricts each node to a maximum of two children, while a general tree does not.**
