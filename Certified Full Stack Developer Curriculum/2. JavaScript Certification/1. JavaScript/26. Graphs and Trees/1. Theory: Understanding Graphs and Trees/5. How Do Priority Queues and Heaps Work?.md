...
![Image 1: A max-heap tree structure showing nodes with values 8 at the root, 7 and 5 as children of 8, and 2 and 1 as children of 7, demonstrating that each parent node is greater than its children.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/how-do-priority-queues-and-heaps-work-1.png)
...
![Image 2: A min-heap tree structure showing nodes with values 4 at the root, 7 and 9 as children of 4, and 12 and 15 as children of 7, demonstrating that each parent node is less than its children.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/how-do-priority-queues-and-heaps-work-2.png)
...
Q) What is the primary characteristic that distinguishes a priority queue from a standard queue or stack?
...
**Answer: It retrieves elements based on an assigned priority.**

---

Q) Which of the following is a common real-world application where a priority queue would be helpful?
...
**Answer: Scheduling tasks in an operating system where some tasks are more urgent.**

---

Q) What is the main reason why heaps are typically implemented as arrays in practice, despite being conceptualized as trees?
...
**Answer: Arrays simplify the logic for accessing parent and child nodes using mathematical formulas.**
