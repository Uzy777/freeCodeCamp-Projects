...
![Image 1: A tree diagram showing nodes A through G arranged in a hierarchy. Node A is at the root, with children B and C. Node B has children D and E, and node C has children F and G.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/how-do-depth-first-and-breadth-first-search-work-1.png)
**Step 1:**
...
![Image 2: The same tree diagram with arrows showing the BFS traversal order: A to B to C to D to E to F to G, demonstrating level-by-level visitation.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/how-do-depth-first-and-breadth-first-search-work-2.png)
...
![Image 3: The same tree diagram as before, showing nodes A through G in their hierarchical structure, ready for DFS demonstration.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/how-do-depth-first-and-breadth-first-search-work-3.png)
**Step 1:**
...
![Image 4: The tree diagram with numbers showing the DFS traversal order: A(1), B(2), D(3), E(4), C(5), F(6), G(7), demonstrating depth-first exploration of branches.](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/how-do-depth-first-and-breadth-first-search-work-4.png)
...
Q) Which of the following data structures is commonly used to implement a standard breadth-first search (BFS) algorithm?
...
Q) Which of the following statements about depth-first search (DFS) is true?
...
**Answer: Depth-first search is typically implemented using recursion or a stack.**

---

Q) If you wanted to find the shortest path from a starting node to a target node in an unweighted graph, which algorithm would be the most suitable choice?
