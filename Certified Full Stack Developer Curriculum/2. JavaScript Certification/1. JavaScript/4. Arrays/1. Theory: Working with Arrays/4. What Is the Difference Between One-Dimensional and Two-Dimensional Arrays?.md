...
*Q1) How many indices do you need to access an element in a two-dimensional array?*
...
*Q2) What kind of data structure is best represented by a one-dimensional array?*

A) A grid of numbers.  
B) A list of items.  
C) A table of information.  
D) A 3D model.  
...
*Q3) In JavaScript, what is a two-dimensional array, essentially?*

A) A special data type built into the language  
B) An array of arrays.  
C) A linked list of arrays.  
D) A matrix object.  
