...
![Image 1: graph comparing time complexity](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-is-an-algorithm-and-how-does-big-o-notation-work-1.png)
...
**Answer: A set of step-by-step instructions designed to solve a problem or perform a task.**

---

Q) What is the primary purpose of Big O notation in the context of algorithms?
...
**Answer: To describe how the resource usage of an algorithm grows as the input size increases.**

---

Q) If an algorithm has a time complexity of O(n), what does this mean about its performance?
...
**Answer: The algorithm's running time increases proportionally with the input size.**
