...
Q) What is the main difference in size between a static array and a dynamic array?
...
**Answer: Static arrays have a fixed size, while dynamic arrays can change size during runtime.**

---

Q) If you need to add more elements to a static array that is already full, what is the typical process involved?
...
**Answer: You must create a new, larger array and copy all existing elements to it.**

---

Q) In which scenario would a static array typically be a more suitable choice than a dynamic array?
...
**Answer: When the data size is fixed and known at the time the program is written.**
