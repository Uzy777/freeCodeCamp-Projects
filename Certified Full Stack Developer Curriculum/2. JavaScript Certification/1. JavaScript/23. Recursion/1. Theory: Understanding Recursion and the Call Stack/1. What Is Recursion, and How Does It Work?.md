...
2) In the context of recursion, what is the call stack used for?
...
**Answer: To track and resolve function calls.**

---

3) What happens when a recursive function call reaches its base case?
...
**Answer: It returns and allows the previous call to resume execution.**
