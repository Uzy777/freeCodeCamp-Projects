...
Q) In JavaScript, how is a basic regular expression defined?
...
**Answer: Using forward slashes: /pattern/**

---

Q) What does the test() method return when used with a regular expression?
...
Q) What happens when you use the match() method with a regular expression on a string that doesn't contain a match?
