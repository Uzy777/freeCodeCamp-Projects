...
Q) Which character class matches any single character EXCEPT line breaks?
...
Q) What does the character class \w match?
...
**Answer: Any letter, number, or underscore.**

---

Q) How would you create a custom character class that matches any uppercase or lowercase letter, but NOT numbers or underscores?
