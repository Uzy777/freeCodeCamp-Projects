...
Q) What modifier should be added to a regular expression to match all occurrences of a pattern in a string?
...
Q) What is the main difference between match() and matchAll() methods when used with a global regular expression?
...
**Answer: match() returns an array, while matchAll() returns an Iterator.**

---

Q) How can you convert the result of matchAll() into an array containing all matches?
...
**Answer: By using Array.from() with the result as an argument.**
