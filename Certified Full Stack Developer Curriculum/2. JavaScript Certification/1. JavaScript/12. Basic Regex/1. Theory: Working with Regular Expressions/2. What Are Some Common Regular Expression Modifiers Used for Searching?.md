...
Q) When would you NOT want to use the global (g) flag in a regular expression?
...
**Answer: When you are testing multiple strings and don't need to track match state.**

---

Q) What does the multi-line (m) modifier do in a regular expression?
...
**Answer: It allows anchors (^ and $) to match the start and end of each line, not just the entire string.**
