...
Q) How do you create a named capturing group in a regular expression?
...
Q) In a replace() method, how would you reference the first capturing group in the replacement string?
...
Q) What is the purpose of a non-capturing group in a regular expression?
...
**Answer: To create alternate patterns without sacrificing readability or performance**
