...
Q) What is the syntax for a positive lookahead assertion in a regular expression?
...
Q) Which assertion would you use to match a word only if it is NOT followed by a specific pattern?
...
Q) When using a lookbehind assertion with String.prototype.match, what part of the string is actually included in the match result?
...
**Answer: The pattern after the lookbehind assertion.**
