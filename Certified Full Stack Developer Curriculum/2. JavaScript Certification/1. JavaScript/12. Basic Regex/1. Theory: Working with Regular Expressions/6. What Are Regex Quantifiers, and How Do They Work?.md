...
Q) What does the quantifier {4,6} mean in a regular expression?
...
**Answer: Match at least four times, but no more than six times.**

---

Q) Which quantifier symbol is equivalent to {0,1} in regular expressions?
...
Q) What does the + quantifier mean in a regular expression?
...
**Answer: Match one or more times.**
