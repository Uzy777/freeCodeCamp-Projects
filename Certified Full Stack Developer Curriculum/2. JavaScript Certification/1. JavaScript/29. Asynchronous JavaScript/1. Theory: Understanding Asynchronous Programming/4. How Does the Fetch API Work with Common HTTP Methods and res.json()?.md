...
Q) When sending data with a POST request using fetch(), what do you need to do with the data before including it in the body?
...
**Answer: Convert it to a JSON string.**

---

Q) What does the response.json() method do?
...
**Answer: Parses the response body as JSON.**
