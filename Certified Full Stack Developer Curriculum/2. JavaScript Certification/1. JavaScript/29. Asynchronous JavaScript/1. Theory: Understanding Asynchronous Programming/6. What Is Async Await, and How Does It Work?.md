...
**Answer: To indicate that a function will always return a Promise.**

---

Q) Where can the await keyword be used in JavaScript?
...
**Answer: Inside async functions.**

---

Q) What happens when an error occurs in an awaited Promise?
...
**Answer: The error can be caught using a try...catch block.**
