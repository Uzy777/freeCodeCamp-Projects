...
Q) What is the primary function of a JavaScript engine?
...
**Answer: To read, interpret, and execute JavaScript code.**

---

Q) Which of the following is NOT typically considered part of the JavaScript runtime?
...
**Answer: The JavaScript code you write.**

---

Q) Which of the following best describes the difference between a JavaScript engine and its runtime?
...
**Answer: The engine parses and executes code; the runtime provides the engine plus additional features like the Fetch API and the DOM.**
