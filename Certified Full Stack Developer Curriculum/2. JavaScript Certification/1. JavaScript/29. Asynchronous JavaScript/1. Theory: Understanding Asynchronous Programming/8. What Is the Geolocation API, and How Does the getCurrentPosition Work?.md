...
Q) What is the primary purpose of the Geolocation API's getCurrentPosition method?
...
**Answer: To retrieve the user's current geographic location.**

---

Q) What object is used to access the Geolocation API in JavaScript?
...
Q) What is a key privacy consideration when using the Geolocation API?
...
**Answer: Obtaining user permission before accessing location.**
