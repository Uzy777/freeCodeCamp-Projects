...
**Answer: To associate a tab with the section it controls.**
...
**Answer: It hides or shows sections based on which tab is selected.**
...
**Answer: To identify the content section that a tab controls.**
