...
**Answer: To indicate that an element's content is changing dynamically.**
...
**Answer: polite announces updates after the current task is finished, while assertive announces updates immediately.**
