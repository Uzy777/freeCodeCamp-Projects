...
1) What is a key characteristic of a pure function?
...
**Answer: It always produces the same output for the same input.**

---

2) Which of the following is considered a side effect in functional programming?
...
3) What is a benefit of avoiding side effects in functional programming?
...
**Answer: It makes the code easier to understand and test.**
