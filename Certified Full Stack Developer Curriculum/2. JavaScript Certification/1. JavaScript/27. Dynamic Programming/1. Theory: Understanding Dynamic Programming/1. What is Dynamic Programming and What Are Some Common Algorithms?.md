...
Q) What are the two key conditions that must be present for dynamic programming to be applicable?
...
Q) What is the main difference between memoization and tabulation approaches in dynamic programming?
...
Q) In the naive recursive climbing stairs implementation, what is the time complexity and why is it inefficient?
...
**Answer: O(2^n) because it recalculates the same subproblems multiple times.**
