...
Q) What causes a SyntaxError in JavaScript?
...
**Answer: Writing something incorrectly in your code, like missing a parenthesis or semicolon.**

---

Q) What will happen if you try to call a variable that holds a number as if it were a function?
...
Q) Which error occurs when you assign an invalid value, such as -1, to an array's length?
