...
Q) What is the debugger used for?
...
**Answer: Pausing code execution.**

---

Q) What additional behavior do modern browsers provide when encountering a debugger statement?
...
**Answer: They keep reloading the page and allow you to resume by clicking a play button.**

---

Q) What will be the output of the following code while the console is open?
...
**Answer: The code execution pauses at the debugger statement.**
