...
Q) What best describes the try block?
...
**Answer: It’s a safe wrapper for code that might throw an error.**

---

Q) Which block always executes even if an error occurs?
...
**Answer: To handle errors gracefully without crashing the program.**
