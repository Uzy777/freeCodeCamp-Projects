...
Q) In which tab of the Chrome developer tools do you have access to adding breakpoints?
...
Q) What do watch expressions allow you to do?
...
**Answer: Monitor the values of variables or expressions, even if they are out of the current scope.**

---

Q) What method can you use to see an interactive list of properties for the JavaScript object you pass in?
