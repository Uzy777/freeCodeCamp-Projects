...
1) What does the addTextTrack() method do?
...
**Answer: Allows you to specify a text track to associate with the media element.**

---

2) Which event fires when the media can be played in its entirety without interruption?
...
**Answer: canplaythrough**

---

3) Which event fires when playback is automatically paused due to data buffering?
