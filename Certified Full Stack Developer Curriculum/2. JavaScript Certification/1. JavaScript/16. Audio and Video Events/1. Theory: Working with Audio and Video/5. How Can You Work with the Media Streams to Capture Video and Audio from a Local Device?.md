...
1) Which method is used to access the user's media devices?
...
2) In the constraints object for video, what does the ideal property represent?
...
**Answer: The preferred resolution.**

---

3) What is returned by the getUserMedia() method?
