...
1) Which of these differentiates a Map from a WeakMap in JavaScript?
...
**Answer: A Map allows keys of any type, while a WeakMap only allows objects as keys.**

---

2) Which property lets you know the number of items in a Map?
...
3) Which method lets you add an item to a Map and a WeakMap?
