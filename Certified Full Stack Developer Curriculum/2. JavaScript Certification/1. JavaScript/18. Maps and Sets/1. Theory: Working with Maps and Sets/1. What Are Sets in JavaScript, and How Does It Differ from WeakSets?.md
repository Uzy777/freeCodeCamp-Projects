...
1) How does a Set differ from a WeakSet when it comes to the data they both support?
...
**Answer: A Set stores any type, including primitives, while a WeakSet allows only weakly held object references.**

---

2) How do you create a Set or a WeakSet in JavaScript?
...
**Answer: By using the Set or WeakSet constructor with the new keyword**

---

3) Which methods are available to both a Set and a WeakSet in JavaScript?
