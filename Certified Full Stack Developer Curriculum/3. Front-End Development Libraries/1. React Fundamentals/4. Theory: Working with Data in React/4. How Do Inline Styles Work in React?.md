...
Q) In React inline styles, how should the CSS property background-color be written?
...
Q) What is an advantage of using inline styles in React?
...
**Answer: They allow for easy dynamic styling based on component state or props.**

---

Q) How are inline styles applied to a React element?
...
**Answer: Using the style attribute with a JavaScript object.**
