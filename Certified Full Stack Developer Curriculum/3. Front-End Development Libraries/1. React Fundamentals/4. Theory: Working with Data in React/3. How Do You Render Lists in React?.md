...
Q) What is the primary purpose of using the key prop when rendering lists in React?
...
**Answer: To help React identify changes in the list efficiently.**

---

Q) Which JavaScript method is typically used to transform an array of data into an array of JSX elements in React?
...
Q) When rendering a list of items that have unique IDs, what is considered the best practice for the key prop?
...
**Answer: Use the item's unique ID.**
