...
Q) What is the primary reason React uses className instead of class for HTML elements in JSX?
...
Q) In the context of React components, what is JSX?
...
Q) How would you render a Message component in React?
