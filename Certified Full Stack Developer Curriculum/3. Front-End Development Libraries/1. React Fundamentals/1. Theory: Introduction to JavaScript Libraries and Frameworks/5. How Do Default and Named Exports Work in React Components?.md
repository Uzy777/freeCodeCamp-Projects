...
Q) How would you export multiple components from the same file using named exports?
...
**Answer: export function Cat() { ... } export function Dog() { ... }**

---

Q) Where would you typically import a child component like the Cat component in a React project?
...
**Answer: In a parent component or the root component file (typically App.jsx).**

---

Q) What is the purpose of the import statement in the App component?
...
**Answer: It imports the Cat component, allowing it to be used within the App component.**
