...
Q) What is the purpose of the useOptimistic hook?
...
**Answer: It helps manage optimistic updates by updating the UI immediately while waiting for an async operation, like a server response.**

---

Q) How is the useOptimistic hook different from a loading state?
...
**Answer: A loading state shows UI feedback while waiting for a response, whereas useOptimistic updates the UI immediately based on an expected outcome.**

---

Q) What does addOptimistic do in the useOptimistic hook syntax below?
...
**Answer: It applies the optimistic update before the actual state changes, providing a smoother user experience.**
