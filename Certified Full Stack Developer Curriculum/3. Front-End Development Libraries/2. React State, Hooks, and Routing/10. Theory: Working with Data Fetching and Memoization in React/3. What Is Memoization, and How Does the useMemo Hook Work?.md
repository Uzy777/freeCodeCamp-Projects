...
**Answer: A technique that caches values and functions to prevent unnecessary recalculations.**

---

Q) What is the difference between computed values and function references?
...
**Answer: Computed values are the result of executing a function, while function references are the function objects in memory.**

---

Q) Which of these is NOT one of the tools React provides for memoization?
