...
Q) What is the purpose of the useActionState hook in React?
...
**Answer: It manages state based on the result of an action, including form submissions, button clicks, and other event-driven updates.**

---

Q) Why can't you use the useActionState hook inside a server component?
...
**Answer: Because useActionState is a React hook, and hooks can only be used inside client components.**

---

Q) Which version of React introduced server components and server actions?
