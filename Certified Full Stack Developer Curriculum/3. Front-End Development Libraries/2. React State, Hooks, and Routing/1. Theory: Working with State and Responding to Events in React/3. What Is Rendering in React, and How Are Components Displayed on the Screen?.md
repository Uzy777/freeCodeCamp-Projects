...
Q) What are the three stages of the rendering process in React?
...
**Answer: Trigger, render, and commit.**

---

Q) Which technology does React use to perfect the render stage by efficiently calculating changes?
...
Q) What happens during the commit stage in React's rendering process?
...
**Answer: React applies changes from the virtual DOM to the real DOM.**
