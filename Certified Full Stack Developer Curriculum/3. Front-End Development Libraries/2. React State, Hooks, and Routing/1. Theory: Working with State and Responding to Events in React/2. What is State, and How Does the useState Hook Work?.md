...
Q) In which version of React were hooks introduced, allowing state to be used in functional components?
...
Q) What does state represent in a React component?
...
**Answer: Dynamic data that triggers re-renders when changed.**

---

Q) Which of the following is the correct way to work with the useState hook?
...
**Answer: const [formData, setFormData] = useState({ name: "", username: "", email: "" });**
