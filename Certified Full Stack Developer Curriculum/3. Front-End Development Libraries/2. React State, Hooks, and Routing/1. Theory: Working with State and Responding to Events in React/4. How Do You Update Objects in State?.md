...
Q) How does React treat state in a component?
...
**Answer: As immutable, meaning it should not be modified directly.**

---

Q) How should you update an object stored in React state?
...
**Answer: Use the setter function to create a new object.**

---

Q) What is the setter function in this code?
