...
Q) How does React handle events consistently across different browsers?
...
**Answer: Through its Synthetic Event System.**

---

Q) How can you prevent default behaviors, like a browser refresh in React?
...
**Answer: By calling the preventDefault() method.**

---

Q) How does React differ from standard HTML in naming event attributes?
...
**Answer: React uses camelCase event names like onClick and onSubmit.**
